defmodule UspsEx.Legacy.Package do
  @moduledoc """
  ...
  by joining the descriptions of each of the items.
      ...
      UspsEx.Legacy.Package.package(%{length: 8,
                                width: 8,
                                height: 8,
                                items: [
...
defmodule UspsEx.Legacy.Package.Extras do
  defstruct cod: nil,
            insurance: nil,
            pricing_and_availability: nil
end

defmodule UspsEx.Legacy.Package.Extras.Cod do
  defstruct amount: nil,
            currency: nil,
            payment_method: nil
end

defmodule UspsEx.Legacy.Package.Extras.Insurance do
  defstruct amount: nil,
            currency: nil,
            content: nil,
            provider: nil
