defmodule UspsEx.Legacy.Item do
  @moduledoc """
  Defines a struct for storing an `UspsEx` in a `Package`.
  ...
  @doc """
  Builds and returns an `UspsEx`. Use this instead of directly initializing the
  struct.
  """
  @spec new(map()) :: t()
  def new(attrs) do
