defmodule UspsEx.Legacy.Service do
  @moduledoc """
  ...
  ## Example
        ...
        iex> UspsEx.Legacy.Service.services_for_carrier(:usps)
        [
          %UspsEx.Legacy.Service{id: :usps_next_day_air,  description: "USPS Next Day Air"},
          %UspsEx.Legacy.Service{id: :usps_second_day_air, description: "USPS 2nd Day Air"},
          %UspsEx.Legacy.Service{id: :usps_three_day_select,  description: "USPS 3 Day Select"},
          %UspsEx.Legacy.Service{id: :usps_ground,  description: "USPS Ground"}
        ]
  """

  alias __MODULE__, as: S
  alias UspsEx.Legacy.Shipment
