defmodule UspsEx.InternationalPrices.InternationalLetterRatesQueryNonMachinableIndicators do
  @moduledoc """
  Provides struct and type for a InternationalLetterRatesQueryNonMachinableIndicators
  """
